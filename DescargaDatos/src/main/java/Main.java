...
public class Main {
    public static void main(String[] args){
        ...
        System.setProperty("webdriver.chrome.driver", "D:\\TFGAlvaroSanchez\\DescargaDatos\\chromedriver_win32\\chromedriver.exe");
        ...
        Select desplegable1 = new Select(driver.findElement(By.id("clim2")));
        ...
        for (int anoInt = 2010; anoInt < 2012; anoInt++) {
            ...
            for (int provincia = 1; provincia <= ld1.size()-1; provincia++) {
                ...
                desplegable1 = new Select(driver.findElement(By.id("clim2")));
                ...
                Select desplegable2 = new Select(driver.findElement(By.id("clim22")));
                ...
                for (int estacionEnProvincia = 1; estacionEnProvincia <= ld2.size()-1; estacionEnProvincia++) {
                    ...
                    desplegable2 = new Select(driver.findElement(By.id("clim22")));
                    ...
                    String estacionMeterologica = driver.findElement(By.xpath("/html//tr[18]/td[3]/div/button/span")).getText();
                    estacionMeterologica = estacionMeterologica.replaceAll("/", " ");

                    driver.findElement(By.id("anioIni2")).sendKeys(ano);
                    driver.findElement(By.id("bclim2")).click();
                    ...
                    if(texto.contains("\"descripcion\" : \"exito\"")) {
                        ...
                        String ubicacionGuardar = "D:\\TFGAlvaroSanchez\\data\\";
